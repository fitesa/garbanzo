...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.102541 && value <= -0.004790) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.004790 && value <= 0.092962) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.092962 && value <= 0.190714) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.190714 && value <= 0.288466) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.288466 && value <= 0.386218) {
            style = [ new ol.style.Style({
