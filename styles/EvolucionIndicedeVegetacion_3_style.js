...
var style_EvolucionIndicedeVegetacion_3 = function(feature, resolution){
    ...
    if (value >= -0.180614 && value <= -0.111328) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.111328 && value <= -0.042042) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.042042 && value <= 0.027244) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.027244 && value <= 0.096530) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.096530 && value <= 0.165816) {
            style = [ new ol.style.Style({
