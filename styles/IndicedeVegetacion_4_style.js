...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.321111 && value <= 0.410639) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.410639 && value <= 0.500167) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.500167 && value <= 0.589695) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.589695 && value <= 0.679223) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.679223 && value <= 0.768751) {
            style = [ new ol.style.Style({
